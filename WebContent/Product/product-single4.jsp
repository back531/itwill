    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="<%=request.getContextPath() %>/images/product-43.jpg" class="image-popup prod-img-bg"><img src="<%=request.getContextPath()%>/images/product-43.jpg" class="img-fluid" alt="Colorlib Template" style="width: 500px; "></a>
    			</div>
          ...
          <div class="col-md-12 tab-wrap">
            ...
            <div class="tab-content bg-light" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
              	<div class="p-4">
	              	<h3 class="mb-4">백련 생막걸리</h3>
	              	<p>신평면에서 일조량이 좋은 바닷가의 비옥한 토지에서 만드는 막걸리</p>
              	</div>
              </div>             
              </div>
            </div>
