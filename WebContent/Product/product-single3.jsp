    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="<%=request.getContextPath() %>/images/product-36.jpg" class="image-popup prod-img-bg"><img src="<%=request.getContextPath()%>/images/product-36.jpg" class="img-fluid" alt="Colorlib Template" style="width: 500px; "></a>
    			</div>
          ...
          <div class="col-md-12 tab-wrap">
            ...
            <div class="tab-content bg-light" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
              	<div class="p-4">
	              	<h3 class="mb-4">우도 땅콩 막걸리</h3>
	              	<p>제주도 우도 땅콩을 소재로 만들었으며 충북 청주의 양조장에서 생산</p>
              	</div>
              </div>             
              </div>
            </div>
