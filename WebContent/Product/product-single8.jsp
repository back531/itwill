    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="<%=request.getContextPath() %>/images/product-33.jpg" class="image-popup prod-img-bg"><img src="<%=request.getContextPath()%>/images/product-33.jpg" class="img-fluid" alt="Colorlib Template" style="width: 500px; "></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<p class="price"><span>6500₩</span></p>
          ...
          <div class="col-md-12 tab-wrap">
            ...
            <div class="tab-content bg-light" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
              	<div class="p-4">
	              	<h3 class="mb-4">추사백</h3>
	              	<p>40년동안 사과밭을 가꾸어온 경험과 함께 캐나다에서 배워온 양조 기술을 접목시켜 새로운 증류주를 개발</p>
              	</div>
              </div>             
              </div>
            </div>
