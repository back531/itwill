    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="<%=request.getContextPath() %>/images/product-47.jpg" class="image-popup prod-img-bg"><img src="<%=request.getContextPath()%>/images/product-47.jpg" class="img-fluid" alt="Colorlib Template" style="width: 500px; "></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<p class="price"><span>4500₩</span></p>
          ...
          <div class="col-md-12 tab-wrap">
            ...
            <div class="tab-content bg-light" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
              	<div class="p-4">
	              	<h3 class="mb-4">꽃빛담은</h3>
	              	<p>고창서해안 꽃빛담은 청정고창 소주 17.3도 360ml 20가지 꽃을 담은 술</p>
              	</div>
              </div>             
              </div>
            </div>
