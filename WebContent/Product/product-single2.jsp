    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="<%=request.getContextPath() %>/images/product-14.jpg" class="image-popup prod-img-bg"><img src="<%=request.getContextPath()%>/images/product-14.jpg" class="img-fluid" alt="Colorlib Template" style="width: 500px; "></a>
    			</div>
          ...
          <div class="col-md-12 tab-wrap">
            ...
            <div class="tab-content bg-light" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
              	<div class="p-4">
	              	<h3 class="mb-4">양반안동소주</h3>
	              	<p>100%국내산 쌀과 안동고지대의 천연 암반수를 이용하여 현대식 공정으로 감암증류 방식으로 생산</p>
              	</div>
              </div>             
              </div>
            </div>
