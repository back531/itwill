    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="<%=request.getContextPath() %>/images/product-15.jpg" class="image-popup prod-img-bg"><img src="<%=request.getContextPath()%>/images/product-15.jpg" class="img-fluid" alt="Colorlib Template" style="width: 500px; "></a>
    			</div>
          ...
          <div class="col-md-12 tab-wrap">
            ...
            <div class="tab-content bg-light" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
              	<div class="p-4">
	              	<h3 class="mb-4">이도 담금주</h3>
	              	<p>술맛 좋기로 인정받은 상압증류방식의 동증류기로 증류하여 증류주 본연의 향기가 그윽하고 깊습니다. 
							담금주 용도가 아니라 그냥 마셔도 충분히 좋은 증류주입니다</p>
              	</div>
              </div>             
              </div>
            </div>
