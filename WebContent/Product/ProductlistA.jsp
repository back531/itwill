							...
							<div class="img d-flex align-items-center justify-content-center"
								...
								<div class="desc">
									<p class="meta-prod d-flex">
										...
										<a href="<%=request.getContextPath() %>/product/product-single.jsp?no=<%=dto.getPID() %>" class="d-flex align-items-center justify-content-center">
