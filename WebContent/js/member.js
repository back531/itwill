...
$(function(){
	 $('#email2').change(function(){
         if( $(this).val()=='etc'){
            $('#email3').val('');
            $('#email3').css('visiblity','visible');
            $('#email3').focus();
         }else{
            $('#email3').css('visiblity','hidden');
         }
      });   
      ...
      $('#btnZipcode').click(function(){
         ...
         open('../zipcode/zipcode.jsp'+zipcode,'zip','width=500,height=600,left=0,top=0,location=yes,resizable=yes')
      });
