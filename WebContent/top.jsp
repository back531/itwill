	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="product.html">전통주</a>
              	<a class="dropdown-item" href="product.html">막걸리</a>
              	<a class="dropdown-item" href="product.html">증류주</a>
              </div>
            </li>
	        <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">게시판</a>
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="product.html">문의 게시판</a>
              	<a class="dropdown-item" href="product.html">후기 게시판</a>
              </div>
            </li>
	        </ul>
	      </div>
