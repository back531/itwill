	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate mb-5 text-center">
				...
				<h2 class="mb-0 bread"><%=no%>번 후기 글</h2>
			</div>
		</div>
	</div>
</section>
		...
		<div class="text-center">
			<%
				if(vo.getName().equals(session.getAttribute("userid"))){ %>
					<button type="button" class="btn btn-primary" onclick="location.href='reviewBoard.jsp'">목록으로</button>
					<button type="button" class="btn btn-primary" onclick="location.href='reviewBoard_edit.jsp?no=<%=no%>'">수정하기</button>
